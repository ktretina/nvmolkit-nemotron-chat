...
The CI Linux/amd64 image build and push succeeded in GitHub Actions run [`31032058838`](https://github.com/ktretina/nvmolkit-nemotron-chat/actions/runs/31032058838) from commit `aec792aef589adf315ba37c60a3cf145a52c868c` at exact OCI index image `ghcr.io/ktretina/nvmolkit-nemotron-chat@sha256:3dca44cd15b16526f9f02fcd8df0ea54d67032210ab6ddd49dcb98895bc6c3f2`. Its Linux/amd64 manifest digest is `sha256:546de4b2d8394af9cc6275181f7f5a521ada4592401145f8ec656bf63c687f30`, with a compressed payload of 4,135,274,607 bytes (3.8512745937 GiB); container execution and history scan remain pending. Real GPU/nvMolKit execution, hosted Nemotron, and browser acceptance also remain pending, and the new Compose URL has not been parsed by Brev Console; Brev Console and Secure Link acceptance remain unqualified. This CI publication evidence does not qualify the image runtime or live deployment. See [`docs/acceptance/demo-ready-receipt.md`](docs/acceptance/demo-ready-receipt.md) for the historical local evidence and unresolved gates, `deployment/launchable-fields.md` for the pending Brev Console values, and `docs/superpowers/specs/2026-08-04-nvmolkit-nemotron-chat-design.md` for the approved completion boundary.
